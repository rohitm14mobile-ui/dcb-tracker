...
const CATEGORIES = [
  ...
  { id: "upi", label: "UPI card purchase", multiplier: 1, smartbuy: false, baseEligible: true }, // No cap
...
export default function App() {
  ...
  if (!user) {
    return (
      // Added flex-col to force stacked rendering, solving the layout issue.
        ...
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
          ...
          <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
              ...
              <button onClick={openAddModal} className="bg-zinc-900 hover:bg-zinc-800 text-white px-4 py-2.5 rounded-xl font-medium flex items-center justify-center gap-2 shadow-sm text-sm w-full md:w-auto">
